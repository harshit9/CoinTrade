    ...
    <div>
      <div className="px-7 py-3 flex flex-col items-center">
        <p className="text-xl font-semibold">
          Since <span className="text-yellow-400">Bitcoin</span> Halving Countdown
        </p>

        <p className="text-white text-4xl font-bold">
          {(countdown.days)}<span className="text-2xl font-medium">D </span>
          {(countdown.hours)}<span className="text-2xl font-medium">H </span>
          {(countdown.minutes)}<span className="text-2xl font-medium">M </span>
          {(countdown.seconds)}<span className="text-2xl font-medium">S </span>    
        </p>
      </div>
    </div>
  );
